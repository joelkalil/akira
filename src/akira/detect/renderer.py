...
SKILL_HINTS = {
    ...
    ("package_manager", "poetry"): "python/tooling/poetry.md",
    ...
    ("web_framework", "streamlit"): "python/web_framework/streamlit.md",
    ("cli_framework", "typer"): "python/cli_framework/typer.md",
    ("cli_framework", "click"): "python/cli_framework/click.md",
    ("testing", "pytest"): "python/testing/pytest.md",
    ("testing", "unittest"): "python/testing/unittest.md",
    ("testing", "tox"): "python/testing/tox.md",
    ("testing", "nox"): "python/testing/nox.md",
    ("testing", "coverage"): "python/testing/coverage.md",
    ...
    ("database", "redis"): "python/database/redis.md",
    ("tooling", "ruff"): "python/tooling/ruff.md",
    ("tooling", "mypy"): "python/tooling/mypy.md",
    ("tooling", "pyright"): "python/tooling/pyright.md",
    ("tooling", "pre-commit"): "python/tooling/pre_commit.md",
    ...
    ("infrastructure", "aws"): "python/infra/aws.md",
    ("ci_cd", "github-actions"): "python/ci_cd/github_actions.md",
    ("ci_cd", "gitlab-ci"): "python/ci_cd/gitlab_ci.md",
}
